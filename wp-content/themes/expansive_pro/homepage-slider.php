...
<div id="slider" class="slider">
	<div class="slider-slides cycle-slideshow"<?php cpotheme_slider_data();?>>
		...
		<div id="slide_<?php echo $slide_count; ?>" class="slide cycle-slider-active <?php echo $slide_position.' '.$slide_color; ?>" style="background-image:url(<?php echo $image_url[0]; ?>);">
