...
if(!function_exists('cpotheme_setup')){
	...
	function cpotheme_setup(){
		...
		if(!defined('CPOTHEME_CORE')) define('CPOTHEME_CORE', get_template_directory().'/core');
		if(!defined('CPOTHEME_CORE_URL')) define('CPOTHEME_CORE_URL', get_template_directory_uri().'/core');
