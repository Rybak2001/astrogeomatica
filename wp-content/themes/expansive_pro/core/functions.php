...
function cpotheme_get_sidebar_position(){
	...
	if(is_front_page()){ 
		...
		if(is_numeric($front_page)){
			$sidebar_layout = get_post_meta($front_page, 'layout_sidebar', true);
		}else{
...
if(!function_exists('cpotheme_layout_header')){
	function cpotheme_layout_header(){
		...
		if(is_front_page()){
			$front_page = get_option('page_on_front');
			if(is_numeric($front_page)){
				$layout = get_post_meta($front_page, 'page_header', true);
			}else{
				$layout = 'normal';
			}
		}elseif(is_home()){
...
if(!function_exists('cpotheme_layout_title')){
	function cpotheme_layout_title(){
		...
		if(is_front_page()){
			$front_page = get_option('page_on_front');
			if(is_numeric($front_page)){
				$layout = get_post_meta($front_page, 'page_title', true);
			}else{
				$layout = 'none';
			}
		}elseif(is_home()){
...
if(!function_exists('cpotheme_layout_footer')){
	function cpotheme_layout_footer(){
		...
		if(is_front_page()){
			$front_page = get_option('page_on_front');
			if(is_numeric($front_page)){
				$layout = get_post_meta($front_page, 'page_footer', true);
			}else{
				$layout = 'normal';
			}
		}elseif(is_home()){
