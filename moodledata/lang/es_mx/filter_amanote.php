...
$string['openwithbutton'] = 'Abrir con botón';
$string['openwithbutton_help'] = 'Cuando se deshabilita, el recurso es abierto en Amanote cuando el usuario hace clic en el enlace del recurso. Cuando se habilita, en su lugar se muestra un botón junto al recurso para abrirlo en Amanote  y preserva el comportamiento predeterminado de Moodle cuando el usuario hace clic en un recurso.';
