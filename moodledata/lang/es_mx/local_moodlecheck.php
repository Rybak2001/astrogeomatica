...
$string['error_phpdoccontentsinlinetag'] = 'MArca inline phpdocs <b>{$a->tag}</b> encontrada con contenidos incorrectos. Debería coincidir con {@link valid URL} o {@see valid FQSEN}';
...
$string['error_phpdocsinvalidpathtag'] = 'Ruta incorrecta para marca phpdocs <b>{$a->tag}</b> detectada';
...
$string['rule_phpdocsinvalidpathtag'] = 'Las marcas phpdocs usadas tienen rutas correctas';
