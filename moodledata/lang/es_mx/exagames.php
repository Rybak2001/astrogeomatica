...
$string['brain_noquestions'] = '¡Aun no se han configurado preguntas!';
...
$string['tiles_difficultyLabel'] = 'Desvanecido';
$string['tiles_difficultyLabel_easy'] = 'Lento';
$string['tiles_difficultyLabel_hard'] = 'Rápido';
$string['tiles_difficultyLabel_medium'] = 'Promedio';
$string['tiles_randomizeButton'] = 'Aleatorizar';
$string['tiles_resetButton'] = 'Reiniciar';
$string['tiles_saveButton'] = 'Guardar';
$string['tiles_saveText'] = '¿Configuración guardada!';
