...
$string['enableusagetracking'] = 'Habilitar Monitoreo del Uso';
$string['enableusagetrackingdesc'] = '<strong>AVISO DEL MONITOREO DEL USO</strong>

<hr class=\'text-muted\' />

<p>Edwiser a partir de ahora, colectará datos anónimos  para generar estadísticas de uso del producto.</p>

<p>Esta información nos ayudará a guiar el desarrollo en a dirección correcta y a  que prospere la comunidad Edwiser.</p>

<p>Habiendo dicho esto, nosotros no recolectamos sus datos personales o de sus estudiantes durante este proceso. Usted puede deshabilitar esto desde el  plugin en cualquier instante que lo desee para salirse de este servicio.</p>

<p>Está disponible una vista general de los datos recolectados  <strong><a href=\'https://forums.edwiser.org/topic/67/anonymously-tracking-the-usage-of-edwiser-products\' target=\'_blank\'>aquí</a></strong>.</p>';
