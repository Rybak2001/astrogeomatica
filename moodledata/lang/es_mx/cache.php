...
/**
 * Strings for component 'cache', language 'es_mx', version '3.10'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_recommendation_favourite_course_content_items'] = 'Recomendaciones de ítems de contenido del curso';
...
$string['cachedef_user_course_content_items'] = 'Ítems de contenido del usuario (actividades, recursos y sus subtipos) por curso';
$string['cachedef_user_favourite_course_content_items'] = 'Ítems destacados del usuario';
