...
$string['updatedgrades'] = 'Se actualizaron <strong>{$a->gradeupdatescount}</strong> calificaciones y <strong>{$a->feedbackupdatescount}</strong> instancias de retroalimentación.';
