...
$string['incompleteconversation'] = 'Usted debe seleccionar un destinatario para esta conversación; por favor inténtelo de nuevo.';
...
$string['privacy:metadata:authorid'] = 'ID del usuario del autor de la conversación';
$string['privacy:metadata:body'] = 'Texto de la conversación';
$string['privacy:metadata:conversationid'] = 'ID de la conversación';
$string['privacy:metadata:conversationindex'] = 'Índice de la conversación';
$string['privacy:metadata:dialogue_messages'] = 'Mensajes del diálogo';
$string['privacy:metadata:dialogue_participants'] = 'Participantes del diálogo';
$string['privacy:metadata:dialogueflags'] = 'Banderas del diálogo';
$string['privacy:metadata:dialogueid'] = 'ID del diálogo';
$string['privacy:metadata:flag'] = 'Bandera';
$string['privacy:metadata:messageid'] = 'ID del mensaje';
$string['privacy:metadata:state'] = 'Estado';
$string['privacy:metadata:timecreated'] = 'Hora de creación';
$string['privacy:metadata:timemodified'] = 'Hora de modificación';
