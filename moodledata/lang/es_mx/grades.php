...
* Al menos una columna debería contener datos de identidad del usuario -nombre_de_usuario, dirección Email o número ID.
* Otras columnas deberían tener encabezados para actividades existentes o elementos de calificación.

Una hoja de cálculo correctamente formateada puede ser obtenida al primeramente exportar algunas calificaciones. LA hoja de cálculo puede entonce ser editada y se le añaden más calificaciones  y se guarda.
