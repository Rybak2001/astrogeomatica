...
$string['httpsurl_help'] = 'URL completa hacia biblioteca MathJax.';
...
Para usar una instalación local de MathJAX, primeramente descargue la biblioteca completa de MathJax desde https://www.mathjax.org/. Después, instálela en un servidor web. Finalmente, actualice las configuraciones del filtro MathJax httpurl y/o httpsurl para que apunten hacia la URL de su MathJax.js  local.';
