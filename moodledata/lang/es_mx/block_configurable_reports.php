...
$string['datatablesinfo'] = 'Biblioteca JS de Tablas de Datos (Ordenamiento de columnas, encabezado fijo, búsqueda, paginación...)';
$string['date'] = 'Fecha';
...
$string['reporttableuiinfo'] = 'Mostrar la tabla de reporte como: Simple, tabla HTML desplazable, JQuery con ordenamiento de columnas o biblioteca de Tablas de Datos JS (ordenamiento de columnas, encabezado fijo, búsqueda, paginación...)';
