...
$string['failedtojump'] = 'No se pudo iniciar comunicación con el servidor remoto';
$string['failedtoping'] = 'No se pudo iniciar comunicación con el servidor externo: {$a}';
