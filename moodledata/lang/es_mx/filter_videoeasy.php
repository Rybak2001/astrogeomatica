...
$string['templaterequire_amd_desc'] = 'AMD es un mecanismo para cargar JavaScript. Si Usted sube o enlaza una biblioteca JavaScript en su plantilla, Usted podría necesitar des-seleccionar esto. Solamente aplica si está en Moodle 2.9 o superior.';
...
$string['templaterequirejs_desc'] = 'Esta es la URL de cualquier biblioteca JavaScript requerida. Intente iniciar con // .';
...
$string['uploadjs_desc'] = 'Usted puede subir un archivo de biblioteca JS que será cargado para su plantilla. Solamente uno.';
