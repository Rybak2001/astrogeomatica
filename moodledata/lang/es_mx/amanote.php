...
$string['key_help'] = 'La clave es necesaria para características avanzadas como Creador de Podcast';
...
$string['openpodcastcreator'] = 'Abrir Creador de Podcast';
$string['openpodcastcreator_help'] = 'El Creador de Podcast le permite grabar un nuevo podcast o editar uno existente.';
...
$string['podcastcreatorbutton'] = 'Abrir Creador de Podcast';
$string['preventdownload'] = 'Impedir Descargar PDF';
$string['preventdownload_desc'] = 'Impedirle a los usuarios el descargar el archivo fuente.';
