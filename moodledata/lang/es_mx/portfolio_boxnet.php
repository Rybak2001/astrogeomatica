...
$string['foldercreatefailed'] = 'No se pudo crear la carpeta destino en Box';
$string['folderlistfailed'] = 'No se pudo obtener una lista de carpetas de Box';
...
$string['sendfailed'] = 'No se pudo enviar contenido a Box: {$a}';
