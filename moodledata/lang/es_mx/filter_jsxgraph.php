...
$string['no'] = 'no';
$string['privacy'] = 'Este plugin solamente es usado para mostrar construcciones JSXGraph escritas en el editor usando la marca (tag) jsxgraph. No almacena ni transmite ninguna información personal identificable. La biblioteca integrada externamente jsxgraphcore.js tampoco procesa ningún dato personal.';
