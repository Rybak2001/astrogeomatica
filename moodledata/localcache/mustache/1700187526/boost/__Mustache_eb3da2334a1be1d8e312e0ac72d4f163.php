...
class __Mustache_eb3da2334a1be1d8e312e0ac72d4f163 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section020eb49e878e3be5d5587678dd0bca19($context, $indent, $value);
        $value = $context->find('events');
        if (empty($value)) {
...
';
    ...
    private function section463e79d3fb5f95f44609fa628392f43b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB5f343ab9711038adaa907957f24a45a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section463e79d3fb5f95f44609fa628392f43b($context, $indent, $value);
                $value = $context->find('iconurl');
                if (empty($value)) {
...
';
    ...
    private function section020eb49e878e3be5d5587678dd0bca19(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionB5f343ab9711038adaa907957f24a45a($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
